...
// MELEE ATTRIBUTES
enemy_melee_damage[0] = 5;
enemy_melee_damage[1] = 12;

enemy_melee_attack_reset_time = round(1.2 * game_get_speed(gamespeed_fps)); 
...
// RANGED ATTRIBUTES
enemy_ranged_damage[0] = 13;
enemy_ranged_damage[1] = 29;
...
enemy_hitbox = spr_slash_small;
enemy_projectile = spr_fireball_medium;
...
// WHY ISNT THIS WORKING WHEN I CHANGE RARITY TO BOSS???
enemy_rarity = enemy_types.elite;
